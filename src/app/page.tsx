...
import { Box, Typography, Button, SxProps, Grid } from "@mui/material";
        ...
        <Box sx={styles.topSection}>
          <Box sx={styles.topSection2}>
            ...
            <Button
              ...
              color="secondary"
              disableElevation
              onClick={() => router.push(isAuth ? "/user/ticket-booking" : "/login")}
            >
              Book Now
            </Button>
          </Box>
            ...
            <Grid item xs={12} sm={6}>
              <Box sx={styles.textContainer} alignItems={"start"}>
                ...
                <Typography sx={styles.sectionSubText}>
                  ...
                  you. Superfast booking process with no service fee + no
              ...
              <Box sx={styles.textContainer} alignItems={"start"}>
                ...
                <Typography sx={styles.sectionSubText}>
                  * Online bus ticket booking keeps you away from the long
                  queues of the offline ticket counters.
                </Typography>
                <Typography sx={styles.sectionSubText}>
                  * reviews, ratings and bus images available.
                </Typography>
                <Typography sx={styles.sectionSubText}>
                  * You can choose the preferred bus type (Volvo Bus, AC or Non
                  AC) and also pickup and dropping point and timings.
                </Typography>
              </Box>
            </Grid>
            <Grid item xs={12} sm={6}>
